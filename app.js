...
function closeModal(){
    const x=qs("modal-backdrop"); if(x) x.remove();
}
...
async function loadChat(){
    const box = qs("chatboard"); box.innerHTML="Loading...";
...
// Monthly PDF (Vessel Joining & Arrivals, including archived)
...
document.addEventListener("DOMContentLoaded", ()=>{
    qs("sticky-text") && (qs("sticky-text").value = sessionStorage.getItem("stickyNote")||"");
});
